...
// TODO rename to blocks shader because it uses all blocks in visible radius
public final class ChunkShader extends ShaderProgram {
    ...
    public static final File COMPUTE_SHADER = new File("shaders/chunk/ChunkLightShader.glsl");
    ...
    public static final AttributeData NORMALS = new AttributeData(6, "normal", 3, AttributeData.ArrayType.FLOAT);
    public static final AttributeData BLOCK_TYPE = new AttributeData(7, "blockType", 1, AttributeData.ArrayType.FLOAT);
    public static final AttributeData FACE_INDEX = new AttributeData(8, "faceIndex", 1, AttributeData.ArrayType.FLOAT);
