...
import com.ternsip.glade.graphics.entities.base.MultiEntity;
...
@Getter
public class FigureText extends MultiEntity {

    public FigureText(File font, String text, Vector3f position, Vector3f scale, Vector4f color) {
